...
#
# Generated by export_simulation on Sun Nov 04 00:59:19 CST 2018
#
################################################################################
...
switch to the './Simulate_HW_1.sh' script.

./Simulate_HW_1.sh -reset_run
...
./Simulate_HW_1.sh -noclean_files

For more information on the script, please type './Simulate_HW_1.sh -help'.
