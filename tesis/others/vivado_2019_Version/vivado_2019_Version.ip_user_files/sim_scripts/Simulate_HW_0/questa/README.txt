...
#
# Generated by export_simulation on Sat Nov 03 17:07:56 CST 2018
#
################################################################################
...
switch to the './Simulate_HW_0.sh' script.

./Simulate_HW_0.sh -reset_run
...
./Simulate_HW_0.sh -noclean_files

For more information on the script, please type './Simulate_HW_0.sh -help'.
