...
proc create_root_design { parentCell } {
  ...
  # Create instance: Simulate_HW_0, and set properties
  set Simulate_HW_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Simulate_HW:1.0 Simulate_HW_0 ]
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 1#UART 1#unassigned#unassigned#Enet 0#Enet 0} \
CONFIG.PCW_MIO_TREE_SIGNALS {unassigned#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#clk#cmd#data[0]#data[1]#data[2]#data[3]#wp#cd#tx#rx#unassigned#unassigned#mdc#mdio} \
...
CONFIG.NUM_PORTS {3} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins Simulate_HW_0/input_r] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Simulate_HW_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net Simulate_HW_0_interrupt [get_bd_pins Simulate_HW_0/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net Simulate_HW_0_output_r_TDATA [get_bd_pins Simulate_HW_0/output_r_TDATA] [get_bd_pins axi_dma_0/s_axis_s2mm_tdata]
  connect_bd_net -net Simulate_HW_0_output_r_TLAST [get_bd_pins Simulate_HW_0/output_r_TLAST] [get_bd_pins axi_dma_0/s_axis_s2mm_tlast]
  connect_bd_net -net Simulate_HW_0_output_r_TVALID [get_bd_pins Simulate_HW_0/output_r_TVALID] [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid]
  ...
  connect_bd_net -net axi_dma_0_s_axis_s2mm_tready [get_bd_pins Simulate_HW_0/output_r_TREADY] [get_bd_pins axi_dma_0/s_axis_s2mm_tready]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Simulate_HW_0/ap_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Simulate_HW_0/s_axi_AXILiteS/Reg] SEG_Simulate_HW_0_Reg
...
preplace inst axi_dma_0 -pg 1 -lvl 4 -y 140 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 4 -y 460 -defaultsOSRD
preplace inst Simulate_HW_0 -pg 1 -lvl 3 -y 150 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 430 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -y 140 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -y 370 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 6 -y 380 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 6 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 6 60 290 NJ 290 NJ 290 NJ 290 NJ 290 2050
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 4 40 -40 340 -40 790 -40 1280
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 -310 280 NJ 280 NJ 280 NJ 280 1290J 300 1600J 280 2060
preplace netloc axi_mem_intercon_M00_AXI 1 5 1 1610
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 2 N 440 770J
preplace netloc axi_dma_0_s_axis_s2mm_tready 1 3 1 800
preplace netloc axi_dma_0_s2mm_introut 1 3 2 850 0 1250
preplace netloc axi_dma_0_M_AXI_MM2S 1 4 1 1290
preplace netloc xlconcat_0_dout 1 4 2 N 460 1610J
preplace netloc Simulate_HW_0_interrupt 1 3 1 780
preplace netloc processing_system7_0_FIXED_IO 1 6 1 NJ
preplace netloc axi_dma_0_mm2s_introut 1 3 2 840 -10 1260
preplace netloc axi_dma_0_M_AXI_S2MM 1 4 1 1300
preplace netloc Simulate_HW_0_output_r_TDATA 1 3 1 780
preplace netloc Simulate_HW_0_output_r_TVALID 1 3 1 810
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 -320 -50 50 -50 360 -50 830 -50 1320 -50 1620 -50 2070
preplace netloc axi_dma_0_M_AXIS_MM2S 1 2 3 370 -20 NJ -20 1270
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 350
preplace netloc Simulate_HW_0_output_r_TLAST 1 3 1 820
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 4 30 -60 NJ -60 NJ -60 1310J
levelinfo -pg 1 -340 -140 200 570 1050 1460 1840 2090 -top -70 -bot 580
",
}
