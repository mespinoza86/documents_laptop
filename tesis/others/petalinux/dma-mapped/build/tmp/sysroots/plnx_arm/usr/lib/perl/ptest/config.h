 ...
 */
#define CPPSTDIN "arm-linux-gnueabihf-gcc  -march=armv7-a -marm -mfpu=neon  -mfloat-abi=hard -mcpu=cortex-a9 -Wl,--hash-style=gnu --sysroot=/home/marco/Documents/tesis/others/petalinux/dma-mapped/build/tmp/sysroots/plnx_arm -E"
#define CPPMINUS "-"
#define CPPRUN "arm-linux-gnueabihf-gcc  -march=armv7-a -marm -mfpu=neon  -mfloat-abi=hard -mcpu=cortex-a9 -Wl,--hash-style=gnu --sysroot=/home/marco/Documents/tesis/others/petalinux/dma-mapped/build/tmp/sysroots/plnx_arm -E"
#define CPPLAST "-"
