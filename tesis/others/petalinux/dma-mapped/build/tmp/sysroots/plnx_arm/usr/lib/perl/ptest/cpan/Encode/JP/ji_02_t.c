/*
 ...
 /scratch/petalinux-yocto/yocto_sdk_minimal_2016.4/build/tmp/sysroots/x86_64-linux/usr/bin/perl-native/perl5.22.1.real ../bin/enc2xs -Q -o ji_02_t.c -f ji_02_t.fnm
 enc2xs VERSION 2.17
*/
#include "encode.h"
