...
if test ! -f Makefile -a -f Makefile.old; then
    ...
    make -f Makefile.old veryclean MAKE='make' PERL_CORE=1 LIBPERL_A=libperl.so
else
    if test ! -f Makefile ; then
	echo "Warning: No Makefile!"
    fi
    make veryclean MAKE='make' PERL_CORE=1 LIBPERL_A=libperl.so
fi
cd ../..
...
rm -f lib/CPAN/Meta/History/Meta_1_0.pod
rm -f lib/CPAN/Meta/History/Meta_1_1.pod
rm -f lib/CPAN/Meta/History/Meta_1_2.pod
rm -f lib/CPAN/Meta/History/Meta_1_3.pod
rm -f lib/CPAN/Meta/History/Meta_1_4.pod
rm -f lib/CPAN/Meta/Merge.pm
...
if test ! -f Makefile -a -f Makefile.old; then
    echo "Note: Using Makefile.old"
    make -f Makefile.old veryclean MAKE='make' PERL_CORE=1 LIBPERL_A=libperl.so LINKTYPE=static
else
    if test ! -f Makefile ; then
	echo "Warning: No Makefile!"
    fi
    make veryclean MAKE='make' PERL_CORE=1 LIBPERL_A=libperl.so LINKTYPE=static
fi
cd ../..
cd ext/B
if test ! -f Makefile -a -f Makefile.old; then
    echo "Note: Using Makefile.old"
    make -f Makefile.old veryclean MAKE='make' PERL_CORE=1 LIBPERL_A=libperl.so LINKTYPE=dynamic
else
    if test ! -f Makefile ; then
	echo "Warning: No Makefile!"
    fi
    make veryclean MAKE='make' PERL_CORE=1 LIBPERL_A=libperl.so LINKTYPE=dynamic
fi
cd ../..
