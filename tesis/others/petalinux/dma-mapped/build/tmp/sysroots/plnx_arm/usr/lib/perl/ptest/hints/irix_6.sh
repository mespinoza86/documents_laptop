...
# /usr/include isn't caught properly.  Hence see the /home/marco/Documents/tesis/others/petalinux/dma-mapped/build/tmp/sysroots/plnx_arm/usr/include/pthread.h
