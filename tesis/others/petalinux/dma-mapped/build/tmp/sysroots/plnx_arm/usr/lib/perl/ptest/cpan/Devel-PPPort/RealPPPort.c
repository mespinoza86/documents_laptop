...
XS_EUPXS(XS_Devel__PPPort_DEFSV)
{
    ...
    {
	SV *	RETVAL;
#line 427 "RealPPPort.xs"
                RETVAL = newSVsv(DEFSV);
#line 669 "RealPPPort.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
#line 683 "RealPPPort.xs"
                char *str;
                STRLEN len;
#line 1206 "RealPPPort.c"
	IV	RETVAL;
	dXSTARG;
#line 686 "RealPPPort.xs"
...
XS_EUPXS(XS_Devel__PPPort_G_ARRAY)
{
	...
	I32	RETVAL;
	dXSTARG;
#line 1199 "RealPPPort.xs"
                RETVAL = G_ARRAY;
#line 2311 "RealPPPort.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_Devel__PPPort_grok_oct)
{
	...
	SV *	string = ST(0)
;
#line 1893 "RealPPPort.xs"
                char *pv;
                I32 flags = 0;
                STRLEN len;
#line 3612 "RealPPPort.c"
	UV	RETVAL;
	dXSTARG;
...
XS_EUPXS(XS_Devel__PPPort_SvREFCNT)
{
    ...
    SP -= items;
    {
#line 2167 "RealPPPort.xs"
                SV *sv, *svr;
#line 4161 "RealPPPort.c"
#line 2169 "RealPPPort.xs"
                sv = newSV(0);
