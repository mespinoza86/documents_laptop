...
#ifndef __Simulate_HW_fptrueOg__HH__
#define __Simulate_HW_fptrueOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Simulate_HW_fptrueOg) {
    ...
    SC_CTOR(Simulate_HW_fptrueOg):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
