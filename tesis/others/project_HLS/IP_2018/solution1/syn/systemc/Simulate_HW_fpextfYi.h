...
#ifndef __Simulate_HW_fpextfYi__HH__
#define __Simulate_HW_fpextfYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Simulate_HW_fpextfYi) {
    ...
    SC_CTOR(Simulate_HW_fpextfYi):  ACMP_fpext_U ("ACMP_fpext_U") {
