...
#ifndef __Simulate_HW_faddfbkb__HH__
#define __Simulate_HW_faddfbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Simulate_HW_faddfbkb) {
    ...
    ACMP_faddfsub<ID, 10, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_faddfsub_U;

    SC_CTOR(Simulate_HW_faddfbkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
