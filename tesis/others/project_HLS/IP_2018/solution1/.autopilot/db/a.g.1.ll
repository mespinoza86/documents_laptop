; ModuleID = '/home/marco/Documents/tesis/buildroot_2018_05/Version_Actualizada/project_HLS/IP_2018/solution1/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.ap_axis.27 = type { float, %struct.ap_uint.26 }
%struct.ap_uint.26 = type { %struct.ap_int_base.25 }
%struct.ap_int_base.25 = type { %struct.ssdm_int.24 }
%struct.ssdm_int.24 = type { i1 }
%"class.hls::stream.28" = type { %struct.ap_axis.27 }

@vertical = internal unnamed_addr global i32 8, align 4 ; [#uses=5 type=i32*]
@savedData = internal global [8 x float] zeroinitializer, align 16 ; [#uses=4 type=[8 x float]*]
@processedData = internal unnamed_addr global [8 x float] zeroinitializer, align 16 ; [#uses=2 type=[8 x float]*]
@nextSavedData = internal global [8 x float] zeroinitializer, align 16 ; [#uses=3 type=[8 x float]*]
@llvm.global_ctors = appending global [1 x { i32, void ()* }] [{ i32, void ()* } { i32 65535, void ()* @_GLOBAL__I_a }] ; [#uses=0 type=[1 x { i32, void ()* }]*]
@blockNumber = internal unnamed_addr global i32 0, align 4 ; [#uses=7 type=i32*]
@V_acc = internal global [8 x float] zeroinitializer, align 16 ; [#uses=4 type=[8 x float]*]
@Simulate_HW.str = internal unnamed_addr constant [12 x i8] c"Simulate_HW\00" ; [#uses=1 type=[12 x i8]*]
@F_acc = internal global [8 x float] zeroinitializer, align 16 ; [#uses=4 type=[8 x float]*]
...
; [#uses=1]
declare void @"_ssdm_op_IfWrite.Stream.%struct.ap_axis.27 = type { float, %struct.ap_uint.26 }P.%struct.ap_axis.27 = type { float, %struct.ap_uint.26 }P"(%struct.ap_axis.27*, %struct.ap_axis.27*)

; [#uses=2]
declare void @"_ssdm_op_IfRead.Stream.%struct.ap_axis.27 = type { float, %struct.ap_uint.26 }P.%struct.ap_axis.27 = type { float, %struct.ap_uint.26 }P"(%struct.ap_axis.27*, %struct.ap_axis.27*)
...
; [#uses=0]
define void @Simulate_HW(%"class.hls::stream.28"* %input, %"class.hls::stream.28"* %output, i32 %size) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecTopModule([12 x i8]* @Simulate_HW.str) nounwind
  %tmp.16 = alloca %struct.ap_axis.27, align 4    ; [#uses=3 type=%struct.ap_axis.27*]
  %tmp.38 = alloca %struct.ap_axis.27, align 4    ; [#uses=3 type=%struct.ap_axis.27*]
  %tmp.39 = alloca %struct.ap_axis.27, align 4    ; [#uses=3 type=%struct.ap_axis.27*]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.28"* %input}, i64 0, metadata !3079), !dbg !3080 ; [debug line = 8:39] [debug variable = input]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.28"* %output}, i64 0, metadata !3081), !dbg !3082 ; [debug line = 8:67] [debug variable = output]
  call void @llvm.dbg.value(metadata !{i32 %size}, i64 0, metadata !3083), !dbg !3084 ; [debug line = 9:7] [debug variable = size]
  call void (...)* @_ssdm_SpecArrayPartition(float* getelementptr inbounds ([8 x float]* @nextSavedData, i64 0, i64 0), i32 1, i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3085 ; [debug line = 19:1]
  call void (...)* @_ssdm_SpecArrayPartition(float* getelementptr inbounds ([8 x float]* @savedData, i64 0, i64 0), i32 1, i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3087 ; [debug line = 20:1]
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3088 ; [debug line = 21:1]
  call void (...)* @_ssdm_SpecArrayPartition(float* getelementptr inbounds ([8 x float]* @F_acc, i64 0, i64 0), i32 1, i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3089 ; [debug line = 22:1]
  call void (...)* @_ssdm_SpecArrayPartition(float* getelementptr inbounds ([8 x float]* @V_acc, i64 0, i64 0), i32 1, i8* getelementptr inbounds ([9 x i8]* @.str, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3090 ; [debug line = 23:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3091 ; [debug line = 24:1]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.28"* %input, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3092 ; [debug line = 25:1]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.28"* %output, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3093 ; [debug line = 26:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %size, i8* getelementptr inbounds ([10 x i8]* @.str2, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3094 ; [debug line = 27:1]
  %input.addr = getelementptr inbounds %"class.hls::stream.28"* %input, i64 0, i32 0, !dbg !3095 ; [#uses=2 type=%struct.ap_axis.27*] [debug line = 131:9@44:15]
  br label %1, !dbg !3101                         ; [debug line = 32:12]

; <label>:1                                       ; preds = %14, %0
  %blockNumber.load = load i32* @blockNumber, align 4, !dbg !3101 ; [#uses=1 type=i32] [debug line = 32:12]
  %tmp = icmp slt i32 %blockNumber.load, %size, !dbg !3101 ; [#uses=1 type=i1] [debug line = 32:12]
  br i1 %tmp, label %2, label %15, !dbg !3101     ; [debug line = 32:12]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([9 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !3102 ; [debug line = 32:40]
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([9 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !3102 ; [#uses=1 type=i32] [debug line = 32:40]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 625, i32 312, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3103 ; [debug line = 33:1]
  call void (...)* @_ssdm_op_SpecPipeline(i32 300, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3104 ; [debug line = 36:1]
  br label %3, !dbg !3105                         ; [debug line = 42:21]

; <label>:3                                       ; preds = %8, %2
  %i = phi i32 [ 0, %2 ], [ %i.4, %8 ]            ; [#uses=3 type=i32]
  %exitcond1 = icmp eq i32 %i, 8, !dbg !3105      ; [#uses=1 type=i1] [debug line = 42:21]
  br i1 %exitcond1, label %.preheader.preheader, label %4, !dbg !3105 ; [debug line = 42:21]

.preheader.preheader:                             ; preds = %3
  br label %.preheader, !dbg !3106                ; [debug line = 53:26]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !3108 ; [debug line = 42:64]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !3108 ; [#uses=1 type=i32] [debug line = 42:64]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.28"* %input}, i64 0, metadata !3109), !dbg !3111 ; [debug line = 129:56@44:15] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%struct.ap_axis.27* %tmp.38}, metadata !3112) nounwind, !dbg !3113 ; [debug line = 130:22@44:15] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{%struct.ap_axis.27* %tmp.38}, i64 0, metadata !3114), !dbg !3117 ; [debug line = 15:8@130:25@44:15] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%struct.ap_axis.27* %tmp.38}, i64 0, metadata !3118), !dbg !3119 ; [debug line = 15:8@15:8@130:25@44:15] [debug variable = this]
  call void @"_ssdm_op_IfRead.Stream.%struct.ap_axis.27 = type { float, %struct.ap_uint.26 }P.%struct.ap_axis.27 = type { float, %struct.ap_uint.26 }P"(%struct.ap_axis.27* %input.addr, %struct.ap_axis.27* %tmp.38) nounwind, !dbg !3095 ; [debug line = 131:9@44:15]
  %this.assign.addr = getelementptr inbounds %struct.ap_axis.27* %tmp.38, i64 0, i32 0, !dbg !3120 ; [#uses=1 type=float*] [debug line = 15:8@44:15]
  %this.assign.load = load float* %this.assign.addr, align 4, !dbg !3120 ; [#uses=7 type=float] [debug line = 15:8@44:15]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %this.assign.load) nounwind
  %this.assign.addr.1 = getelementptr inbounds %struct.ap_axis.27* %tmp.38, i64 0, i32 1, i32 0, i32 0, i32 0, !dbg !3122 ; [#uses=1 type=i1*] [debug line = 277:10@15:8@44:15]
  %this.assign.load.1 = load i1* %this.assign.addr.1, align 4, !dbg !3122 ; [#uses=1 type=i1] [debug line = 277:10@15:8@44:15]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %this.assign.load.1) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %this.assign.load) nounwind
  %tmp.2 = sext i32 %i to i64, !dbg !3124         ; [#uses=3 type=i64] [debug line = 45:4]
  %processedData.addr = getelementptr inbounds [8 x float]* @processedData, i64 0, i64 %tmp.2, !dbg !3124 ; [#uses=1 type=float*] [debug line = 45:4]
  store float %this.assign.load, float* %processedData.addr, align 4, !dbg !3124 ; [debug line = 45:4]
  %blockNumber.load.1 = load i32* @blockNumber, align 4, !dbg !3125 ; [#uses=2 type=i32] [debug line = 46:4]
  %tmp.3 = icmp eq i32 %blockNumber.load.1, 0, !dbg !3125 ; [#uses=1 type=i1] [debug line = 46:4]
  %vertical.load = load i32* @vertical, align 4, !dbg !3125 ; [#uses=2 type=i32] [debug line = 46:4]
  %tmp.4 = icmp eq i32 %vertical.load, 8, !dbg !3125 ; [#uses=1 type=i1] [debug line = 46:4]
  %or.cond = and i1 %tmp.3, %tmp.4, !dbg !3125    ; [#uses=1 type=i1] [debug line = 46:4]
  br i1 %or.cond, label %5, label %6, !dbg !3125  ; [debug line = 46:4]

; <label>:5                                       ; preds = %4
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %this.assign.load) nounwind
  %savedData.addr.1 = getelementptr inbounds [8 x float]* @savedData, i64 0, i64 %tmp.2, !dbg !3126 ; [#uses=1 type=float*] [debug line = 47:5]
  store float %this.assign.load, float* %savedData.addr.1, align 4, !dbg !3126 ; [debug line = 47:5]
  br label %8, !dbg !3128                         ; [debug line = 48:4]

; <label>:6                                       ; preds = %4
  %tmp.18 = icmp eq i32 %blockNumber.load.1, %vertical.load, !dbg !3129 ; [#uses=1 type=i1] [debug line = 48:11]
  br i1 %tmp.18, label %7, label %._crit_edge, !dbg !3129 ; [debug line = 48:11]

; <label>:7                                       ; preds = %6
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %this.assign.load) nounwind
  %nextSavedData.addr.1 = getelementptr inbounds [8 x float]* @nextSavedData, i64 0, i64 %tmp.2, !dbg !3130 ; [#uses=1 type=float*] [debug line = 49:5]
  store float %this.assign.load, float* %nextSavedData.addr.1, align 4, !dbg !3130 ; [debug line = 49:5]
  br label %._crit_edge, !dbg !3132               ; [debug line = 50:4]

._crit_edge:                                      ; preds = %7, %6
  br label %8

; <label>:8                                       ; preds = %._crit_edge, %5
  %rend30 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str6, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !3133 ; [#uses=0 type=i32] [debug line = 51:3]
  %i.4 = add nsw i32 %i, 1, !dbg !3134            ; [#uses=1 type=i32] [debug line = 42:58]
  call void @llvm.dbg.value(metadata !{i32 %i.4}, i64 0, metadata !3135), !dbg !3134 ; [debug line = 42:58] [debug variable = i]
  br label %3, !dbg !3134                         ; [debug line = 42:58]

.preheader:                                       ; preds = %._crit_edge23, %.preheader.preheader
  %i.1 = phi i32 [ %i.5, %._crit_edge23 ], [ 0, %.preheader.preheader ] ; [#uses=3 type=i32]
  %exitcond2 = icmp eq i32 %i.1, 8, !dbg !3106    ; [#uses=1 type=i1] [debug line = 53:26]
  br i1 %exitcond2, label %14, label %9, !dbg !3106 ; [debug line = 53:26]

; <label>:9                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([17 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !3136 ; [debug line = 53:69]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([17 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !3136 ; [#uses=1 type=i32] [debug line = 53:69]
  %tmp.20 = sext i32 %i.1 to i64, !dbg !3138      ; [#uses=5 type=i64] [debug line = 57:5]
  %savedData.addr.2 = getelementptr inbounds [8 x float]* @savedData, i64 0, i64 %tmp.20, !dbg !3138 ; [#uses=1 type=float*] [debug line = 57:5]
  br label %10, !dbg !3141                        ; [debug line = 56:27]

; <label>:10                                      ; preds = %11, %9
  %j = phi i32 [ 0, %9 ], [ %j.1, %11 ]           ; [#uses=3 type=i32]
  %f_acc = phi float [ 0.000000e+00, %9 ], [ %f_acc.2, %11 ] ; [#uses=2 type=float]
  %v_acc = phi float [ 0.000000e+00, %9 ], [ %v_acc.2, %11 ] ; [#uses=2 type=float]
  %exitcond3 = icmp eq i32 %j, 8, !dbg !3141      ; [#uses=1 type=i1] [debug line = 56:27]
  br i1 %exitcond3, label %12, label %11, !dbg !3141 ; [debug line = 56:27]

; <label>:11                                      ; preds = %10
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([17 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !3142 ; [debug line = 56:70]
  %rbegin4 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([17 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !3142 ; [#uses=1 type=i32] [debug line = 56:70]
  %Vi = load float* %savedData.addr.2, align 4, !dbg !3138 ; [#uses=2 type=float] [debug line = 57:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %Vi) nounwind
  call void @llvm.dbg.value(metadata !{float %Vi}, i64 0, metadata !3143), !dbg !3138 ; [debug line = 57:5] [debug variable = Vi]
  %tmp.23 = sext i32 %j to i64, !dbg !3144        ; [#uses=1 type=i64] [debug line = 58:5]
  %processedData.addr.1 = getelementptr inbounds [8 x float]* @processedData, i64 0, i64 %tmp.23, !dbg !3144 ; [#uses=1 type=float*] [debug line = 58:5]
  %Vj = load float* %processedData.addr.1, align 4, !dbg !3144 ; [#uses=2 type=float] [debug line = 58:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %Vj) nounwind
  call void @llvm.dbg.value(metadata !{float %Vj}, i64 0, metadata !3145), !dbg !3144 ; [debug line = 58:5] [debug variable = Vj]
  %V = fsub float %Vi, %Vj, !dbg !3146            ; [#uses=4 type=float] [debug line = 59:5]
  call void @llvm.dbg.value(metadata !{float %V}, i64 0, metadata !3147), !dbg !3146 ; [debug line = 59:5] [debug variable = V]
  %tmp.25 = fmul float %V, %V, !dbg !3148         ; [#uses=1 type=float] [debug line = 60:13]
  %tmp.26 = fmul float %tmp.25, 0xBF847AE140000000, !dbg !3148 ; [#uses=1 type=float] [debug line = 60:13]
  %tmp.27 = call float @llvm.exp.f32(float %tmp.26), !dbg !3148 ; [#uses=1 type=float] [debug line = 60:13]
  %F = fmul float %V, %tmp.27, !dbg !3148         ; [#uses=1 type=float] [debug line = 60:13]
  call void @llvm.dbg.value(metadata !{float %F}, i64 0, metadata !3149), !dbg !3148 ; [debug line = 60:13] [debug variable = F]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.28"* %input}, i64 0, metadata !3109), !dbg !3150 ; [debug line = 129:56@61:20] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%struct.ap_axis.27* %tmp.39}, metadata !3112) nounwind, !dbg !3152 ; [debug line = 130:22@61:20] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{%struct.ap_axis.27* %tmp.39}, i64 0, metadata !3153), !dbg !3155 ; [debug line = 15:8@130:25@61:20] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%struct.ap_axis.27* %tmp.39}, i64 0, metadata !3156), !dbg !3157 ; [debug line = 15:8@15:8@130:25@61:20] [debug variable = this]
  call void @"_ssdm_op_IfRead.Stream.%struct.ap_axis.27 = type { float, %struct.ap_uint.26 }P.%struct.ap_axis.27 = type { float, %struct.ap_uint.26 }P"(%struct.ap_axis.27* %input.addr, %struct.ap_axis.27* %tmp.39) nounwind, !dbg !3158 ; [debug line = 131:9@61:20]
  %this.assign.1.addr = getelementptr inbounds %struct.ap_axis.27* %tmp.39, i64 0, i32 0, !dbg !3159 ; [#uses=1 type=float*] [debug line = 15:8@61:20]
  %this.assign.1.load = load float* %this.assign.1.addr, align 4, !dbg !3159 ; [#uses=5 type=float] [debug line = 15:8@61:20]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %this.assign.1.load) nounwind
  %this.assign.1.addr.1 = getelementptr inbounds %struct.ap_axis.27* %tmp.39, i64 0, i32 1, i32 0, i32 0, i32 0, !dbg !3160 ; [#uses=1 type=i1*] [debug line = 277:10@15:8@61:20]
  %this.assign.1.load.1 = load i1* %this.assign.1.addr.1, align 4, !dbg !3160 ; [#uses=1 type=i1] [debug line = 277:10@15:8@61:20]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %this.assign.1.load.1) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %this.assign.1.load) nounwind
  %tmp.30 = fmul float %F, %this.assign.1.load, !dbg !3161 ; [#uses=1 type=float] [debug line = 62:5]
  %f_acc.2 = fadd float %f_acc, %tmp.30, !dbg !3161 ; [#uses=1 type=float] [debug line = 62:5]
  call void @llvm.dbg.value(metadata !{float %f_acc.2}, i64 0, metadata !3162), !dbg !3161 ; [debug line = 62:5] [debug variable = f_acc]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %this.assign.1.load) nounwind
  %tmp.32 = fmul float %V, %this.assign.1.load, !dbg !3163 ; [#uses=1 type=float] [debug line = 63:5]
  %v_acc.2 = fadd float %v_acc, %tmp.32, !dbg !3163 ; [#uses=1 type=float] [debug line = 63:5]
  call void @llvm.dbg.value(metadata !{float %v_acc.2}, i64 0, metadata !3164), !dbg !3163 ; [debug line = 63:5] [debug variable = v_acc]
  %rend26 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([17 x i8]* @.str8, i64 0, i64 0), i32 %rbegin4) nounwind, !dbg !3165 ; [#uses=0 type=i32] [debug line = 64:4]
  %j.1 = add nsw i32 %j, 1, !dbg !3166            ; [#uses=1 type=i32] [debug line = 56:64]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !3167), !dbg !3166 ; [debug line = 56:64] [debug variable = j]
  br label %10, !dbg !3166                        ; [debug line = 56:64]

; <label>:12                                      ; preds = %10
  %v_acc.0.lcssa = phi float [ %v_acc, %10 ]      ; [#uses=2 type=float]
  %f_acc.0.lcssa = phi float [ %f_acc, %10 ]      ; [#uses=2 type=float]
  %blockNumber.load.3 = load i32* @blockNumber, align 4, !dbg !3168 ; [#uses=1 type=i32] [debug line = 66:4]
  %tmp.22 = icmp eq i32 %blockNumber.load.3, 0, !dbg !3168 ; [#uses=1 type=i1] [debug line = 66:4]
  br i1 %tmp.22, label %._crit_edge23, label %13, !dbg !3168 ; [debug line = 66:4]

; <label>:13                                      ; preds = %12
  %F_acc.addr.1 = getelementptr inbounds [8 x float]* @F_acc, i64 0, i64 %tmp.20, !dbg !3169 ; [#uses=1 type=float*] [debug line = 67:5]
  %F_acc.load.1 = load float* %F_acc.addr.1, align 4, !dbg !3169 ; [#uses=2 type=float] [debug line = 67:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %F_acc.load.1) nounwind
  %f_acc.3 = fadd float %f_acc.0.lcssa, %F_acc.load.1, !dbg !3169 ; [#uses=1 type=float] [debug line = 67:5]
  call void @llvm.dbg.value(metadata !{float %f_acc.3}, i64 0, metadata !3162), !dbg !3169 ; [debug line = 67:5] [debug variable = f_acc]
  %V_acc.addr.1 = getelementptr inbounds [8 x float]* @V_acc, i64 0, i64 %tmp.20, !dbg !3171 ; [#uses=1 type=float*] [debug line = 68:5]
  %V_acc.load.1 = load float* %V_acc.addr.1, align 4, !dbg !3171 ; [#uses=2 type=float] [debug line = 68:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %V_acc.load.1) nounwind
  %v_acc.3 = fadd float %v_acc.0.lcssa, %V_acc.load.1, !dbg !3171 ; [#uses=1 type=float] [debug line = 68:5]
  call void @llvm.dbg.value(metadata !{float %v_acc.3}, i64 0, metadata !3164), !dbg !3171 ; [debug line = 68:5] [debug variable = v_acc]
  br label %._crit_edge23, !dbg !3172             ; [debug line = 69:4]

._crit_edge23:                                    ; preds = %13, %12
  %f_acc.1 = phi float [ %f_acc.3, %13 ], [ %f_acc.0.lcssa, %12 ] ; [#uses=1 type=float]
  %v_acc.1 = phi float [ %v_acc.3, %13 ], [ %v_acc.0.lcssa, %12 ] ; [#uses=1 type=float]
  %F_acc.addr.2 = getelementptr inbounds [8 x float]* @F_acc, i64 0, i64 %tmp.20, !dbg !3173 ; [#uses=1 type=float*] [debug line = 70:4]
  store float %f_acc.1, float* %F_acc.addr.2, align 4, !dbg !3173 ; [debug line = 70:4]
  %V_acc.addr.2 = getelementptr inbounds [8 x float]* @V_acc, i64 0, i64 %tmp.20, !dbg !3174 ; [#uses=1 type=float*] [debug line = 71:4]
  store float %v_acc.1, float* %V_acc.addr.2, align 4, !dbg !3174 ; [debug line = 71:4]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([17 x i8]* @.str7, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3175 ; [#uses=0 type=i32] [debug line = 72:3]
  %i.5 = add nsw i32 %i.1, 1, !dbg !3176          ; [#uses=1 type=i32] [debug line = 53:63]
  call void @llvm.dbg.value(metadata !{i32 %i.5}, i64 0, metadata !3135), !dbg !3176 ; [debug line = 53:63] [debug variable = i]
  br label %.preheader, !dbg !3176                ; [debug line = 53:63]

; <label>:14                                      ; preds = %.preheader
  %blockNumber.load.2 = load i32* @blockNumber, align 4, !dbg !3177 ; [#uses=1 type=i32] [debug line = 74:3]
  %tmp.19 = add nsw i32 %blockNumber.load.2, 8, !dbg !3177 ; [#uses=1 type=i32] [debug line = 74:3]
  store i32 %tmp.19, i32* @blockNumber, align 4, !dbg !3177 ; [debug line = 74:3]
  %rend32 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str5, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !3178 ; [#uses=0 type=i32] [debug line = 75:2]
  br label %1, !dbg !3178                         ; [debug line = 75:2]

; <label>:15                                      ; preds = %1
  %tmp.i.addr = getelementptr inbounds %struct.ap_axis.27* %tmp.16, i64 0, i32 0, !dbg !3179 ; [#uses=1 type=float*] [debug line = 145:31@90:3]
  %tmp.i.addr.1 = getelementptr inbounds %struct.ap_axis.27* %tmp.16, i64 0, i32 1, i32 0, i32 0, i32 0, !dbg !3179 ; [#uses=1 type=i1*] [debug line = 145:31@90:3]
  %output.addr = getelementptr inbounds %"class.hls::stream.28"* %output, i64 0, i32 0, !dbg !3184 ; [#uses=1 type=%struct.ap_axis.27*] [debug line = 146:9@90:3]
  br label %16, !dbg !3185                        ; [debug line = 79:15]

; <label>:16                                      ; preds = %17, %15
  %i.2 = phi i32 [ 0, %15 ], [ %i.3, %17 ]        ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %i.2, 8, !dbg !3185     ; [#uses=1 type=i1] [debug line = 79:15]
  br i1 %exitcond, label %18, label %17, !dbg !3185 ; [debug line = 79:15]

; <label>:17                                      ; preds = %16
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([7 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !3186 ; [debug line = 79:58]
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([7 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !3186 ; [#uses=1 type=i32] [debug line = 79:58]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3187 ; [debug line = 80:1]
  %tmp.7 = sext i32 %i.2 to i64, !dbg !3188       ; [#uses=4 type=i64] [debug line = 81:2]
  %nextSavedData.addr = getelementptr inbounds [8 x float]* @nextSavedData, i64 0, i64 %tmp.7, !dbg !3188 ; [#uses=1 type=float*] [debug line = 81:2]
  %nextSavedData.load = load float* %nextSavedData.addr, align 4, !dbg !3188 ; [#uses=2 type=float] [debug line = 81:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %nextSavedData.load) nounwind
  %savedData.addr = getelementptr inbounds [8 x float]* @savedData, i64 0, i64 %tmp.7, !dbg !3188 ; [#uses=1 type=float*] [debug line = 81:2]
  store float %nextSavedData.load, float* %savedData.addr, align 4, !dbg !3188 ; [debug line = 81:2]
  store i32 0, i32* @blockNumber, align 4, !dbg !3189 ; [debug line = 82:3]
  %vertical.load.2 = load i32* @vertical, align 4, !dbg !3190 ; [#uses=1 type=i32] [debug line = 83:3]
  %tmp.8 = add nsw i32 %vertical.load.2, 1, !dbg !3190 ; [#uses=1 type=i32] [debug line = 83:3]
  store i32 %tmp.8, i32* @vertical, align 4, !dbg !3190 ; [debug line = 83:3]
  %tmp.9 = icmp eq i32 %i.2, 7, !dbg !3191        ; [#uses=2 type=i1] [debug line = 84:3]
  %F_acc.addr = getelementptr inbounds [8 x float]* @F_acc, i64 0, i64 %tmp.7, !dbg !3192 ; [#uses=1 type=float*] [debug line = 89:3]
  %F_acc.load = load float* %F_acc.addr, align 4, !dbg !3192 ; [#uses=2 type=float] [debug line = 89:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %F_acc.load) nounwind
  %tmp.10 = fpext float %F_acc.load to double, !dbg !3192 ; [#uses=1 type=double] [debug line = 89:3]
  %tmp.11 = fmul double %tmp.10, 8.000000e-01, !dbg !3192 ; [#uses=1 type=double] [debug line = 89:3]
  %V_acc.addr = getelementptr inbounds [8 x float]* @V_acc, i64 0, i64 %tmp.7, !dbg !3192 ; [#uses=1 type=float*] [debug line = 89:3]
  %V_acc.load = load float* %V_acc.addr, align 4, !dbg !3192 ; [#uses=2 type=float] [debug line = 89:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %V_acc.load) nounwind
  %tmp.12 = fpext float %V_acc.load to double, !dbg !3192 ; [#uses=1 type=double] [debug line = 89:3]
  %tmp.13 = fmul double %tmp.12, 2.000000e-01, !dbg !3192 ; [#uses=1 type=double] [debug line = 89:3]
  %tmp.14 = fadd double %tmp.11, %tmp.13, !dbg !3192 ; [#uses=1 type=double] [debug line = 89:3]
  %tmp.15 = fptrunc double %tmp.14 to float, !dbg !3192 ; [#uses=2 type=float] [debug line = 89:3]
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.28"* %output}, i64 0, metadata !3193), !dbg !3194 ; [debug line = 144:48@90:3] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%struct.ap_axis.27* %tmp.16}, metadata !3195) nounwind, !dbg !3196 ; [debug line = 145:22@90:3] [debug variable = tmp]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %tmp.15) nounwind
  store float %tmp.15, float* %tmp.i.addr, align 4, !dbg !3179 ; [debug line = 145:31@90:3]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %tmp.9) nounwind
  store i1 %tmp.9, i1* %tmp.i.addr.1, align 4, !dbg !3179 ; [debug line = 145:31@90:3]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_axis.27 = type { float, %struct.ap_uint.26 }P.%struct.ap_axis.27 = type { float, %struct.ap_uint.26 }P"(%struct.ap_axis.27* %output.addr, %struct.ap_axis.27* %tmp.16) nounwind, !dbg !3184 ; [debug line = 146:9@90:3]
  %rend28 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([7 x i8]* @.str9, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !3197 ; [#uses=0 type=i32] [debug line = 91:2]
  %i.3 = add nsw i32 %i.2, 1, !dbg !3198          ; [#uses=1 type=i32] [debug line = 79:52]
  call void @llvm.dbg.value(metadata !{i32 %i.3}, i64 0, metadata !3135), !dbg !3198 ; [debug line = 79:52] [debug variable = i]
  br label %16, !dbg !3198                        ; [debug line = 79:52]

; <label>:18                                      ; preds = %16
  %vertical.load.1 = load i32* @vertical, align 4, !dbg !3199 ; [#uses=1 type=i32] [debug line = 93:2]
  %tmp.5 = add nsw i32 %size, 8, !dbg !3199       ; [#uses=1 type=i32] [debug line = 93:2]
  %tmp.6 = icmp eq i32 %vertical.load.1, %tmp.5, !dbg !3199 ; [#uses=1 type=i1] [debug line = 93:2]
  br i1 %tmp.6, label %19, label %._crit_edge24, !dbg !3199 ; [debug line = 93:2]

; <label>:19                                      ; preds = %18
  store i32 0, i32* @blockNumber, align 4, !dbg !3200 ; [debug line = 94:3]
  store i32 8, i32* @vertical, align 4, !dbg !3202 ; [debug line = 95:3]
  br label %._crit_edge24, !dbg !3203             ; [debug line = 96:2]

._crit_edge24:                                    ; preds = %19, %18
  ret void, !dbg !3204                            ; [debug line = 98:1]
}

!llvm.dbg.cu = !{!0}
!opencl.kernels = !{!3052, !3059, !3065, !3065, !3068, !3068, !3074, !3068, !3077, !3068, !3068, !3068, !3068}
!hls.encrypted.func = !{}
...
!1321 = metadata !{i32 786478, i32 0, metadata !907, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamI7ap_axisILi32ELi1ELi1ELi1EEE5writeERKS2_", metadata !908, i32 144, metadata !1298, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1312, metadata !89, i32 144} ; [ DW_TAG_subprogram ]
!1322 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC1Ei", metadata !918, i32 250, metadata !1218, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1217, metadata !89, i32 250} ; [ DW_TAG_subprogram ]
!1323 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC2Ei", metadata !918, i32 250, metadata !1218, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1217, metadata !89, i32 250} ; [ DW_TAG_subprogram ]
!1324 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi1ELb0ELb1EEC2Ev", metadata !891, i32 1438, metadata !937, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !936, metadata !89, i32 1438} ; [ DW_TAG_subprogram ]
!1325 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi1ELb0EEC2Ev", metadata !925, i32 3, metadata !930, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !929, metadata !89, i32 3} ; [ DW_TAG_subprogram ]
!1326 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZN7ap_uintILi1EEaSERKS0_", metadata !918, i32 276, metadata !1259, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1258, metadata !89, i32 276} ; [ DW_TAG_subprogram ]
!1327 = metadata !{i32 786478, i32 0, metadata !907, metadata !"read", metadata !"read", metadata !"_ZN3hls6streamI7ap_axisILi32ELi1ELi1ELi1EEE4readEv", metadata !908, i32 129, metadata !1307, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1306, metadata !89, i32 129} ; [ DW_TAG_subprogram ]
!1328 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZN7ap_axisILi32ELi1ELi1ELi1EEaSERKS0_", metadata !912, i32 15, metadata !1269, i1 false, i1 true, i32 0, i32 0, null, i32 320, i1 false, null, null, metadata !1268, metadata !89, i32 15} ; [ DW_TAG_subprogram ]
!1329 = metadata !{i32 786478, i32 0, null, metadata !"ap_axis", metadata !"ap_axis", metadata !"_ZN7ap_axisILi32ELi1ELi1ELi1EEC1Ev", metadata !912, i32 15, metadata !1264, i1 false, i1 true, i32 0, i32 0, null, i32 320, i1 false, null, null, metadata !1263, metadata !89, i32 15} ; [ DW_TAG_subprogram ]
!1330 = metadata !{i32 786478, i32 0, null, metadata !"ap_axis", metadata !"ap_axis", metadata !"_ZN7ap_axisILi32ELi1ELi1ELi1EEC2Ev", metadata !912, i32 15, metadata !1264, i1 false, i1 true, i32 0, i32 0, null, i32 320, i1 false, null, null, metadata !1263, metadata !89, i32 15} ; [ DW_TAG_subprogram ]
!1331 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC1Ev", metadata !918, i32 183, metadata !1184, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1183, metadata !89, i32 183} ; [ DW_TAG_subprogram ]
!1332 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC2Ev", metadata !918, i32 183, metadata !1184, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1183, metadata !89, i32 183} ; [ DW_TAG_subprogram ]
...
!1383 = metadata !{i32 786484, i32 0, metadata !1384, metadata !"__ioinit", metadata !"__ioinit", metadata !"_ZStL8__ioinit", metadata !1385, i32 74, metadata !1386, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!1395 = metadata !{i32 786484, i32 0, metadata !901, metadata !"F_acc", metadata !"F_acc", metadata !"", metadata !902, i32 10, metadata !1396, i32 1, i32 1, [8 x float]* @F_acc} ; [ DW_TAG_variable ]
...
!1397 = metadata !{i32 786484, i32 0, metadata !901, metadata !"V_acc", metadata !"V_acc", metadata !"", metadata !902, i32 11, metadata !1396, i32 1, i32 1, [8 x float]* @V_acc} ; [ DW_TAG_variable ]
!1398 = metadata !{i32 786484, i32 0, metadata !901, metadata !"savedData", metadata !"savedData", metadata !"", metadata !902, i32 12, metadata !1396, i32 1, i32 1, [8 x float]* @savedData} ; [ DW_TAG_variable ]
!1399 = metadata !{i32 786484, i32 0, metadata !901, metadata !"nextSavedData", metadata !"nextSavedData", metadata !"", metadata !902, i32 13, metadata !1396, i32 1, i32 1, [8 x float]* @nextSavedData} ; [ DW_TAG_variable ]
!1400 = metadata !{i32 786484, i32 0, metadata !901, metadata !"processedData", metadata !"processedData", metadata !"", metadata !902, i32 14, metadata !1396, i32 1, i32 1, [8 x float]* @processedData} ; [ DW_TAG_variable ]
!1401 = metadata !{i32 786484, i32 0, metadata !901, metadata !"blockNumber", metadata !"blockNumber", metadata !"", metadata !902, i32 15, metadata !56, i32 1, i32 1, i32* @blockNumber} ; [ DW_TAG_variable ]
!1402 = metadata !{i32 786484, i32 0, metadata !901, metadata !"vertical", metadata !"vertical", metadata !"", metadata !902, i32 16, metadata !56, i32 1, i32 1, i32* @vertical} ; [ DW_TAG_variable ]
...
!1405 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdin_", metadata !"_IO_2_1_stdin_", metadata !"", metadata !1406, i32 315, metadata !1407, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1408 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdout_", metadata !"_IO_2_1_stdout_", metadata !"", metadata !1406, i32 316, metadata !1407, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1409 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stderr_", metadata !"_IO_2_1_stderr_", metadata !"", metadata !1406, i32 317, metadata !1407, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1410 = metadata !{i32 786484, i32 0, null, metadata !"sys_nerr", metadata !"sys_nerr", metadata !"", metadata !1411, i32 26, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1412 = metadata !{i32 786484, i32 0, null, metadata !"_sys_nerr", metadata !"_sys_nerr", metadata !"", metadata !1411, i32 30, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1413 = metadata !{i32 786484, i32 0, null, metadata !"signgam", metadata !"signgam", metadata !"", metadata !1414, i32 168, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1415 = metadata !{i32 786484, i32 0, null, metadata !"__digits", metadata !"__digits", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE", metadata !1416, i32 76, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1417 = metadata !{i32 786484, i32 0, null, metadata !"__max_digits10", metadata !"__max_digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E", metadata !1416, i32 111, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1418 = metadata !{i32 786484, i32 0, null, metadata !"__digits10", metadata !"__digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E", metadata !1416, i32 117, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1419 = metadata !{i32 786484, i32 0, null, metadata !"__max_exponent10", metadata !"__max_exponent10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E", metadata !1416, i32 120, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1420 = metadata !{i32 786484, i32 0, null, metadata !"__daylight", metadata !"__daylight", metadata !"", metadata !1421, i32 283, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1422 = metadata !{i32 786484, i32 0, null, metadata !"daylight", metadata !"daylight", metadata !"", metadata !1421, i32 297, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1423 = metadata !{i32 786484, i32 0, null, metadata !"getdate_err", metadata !"getdate_err", metadata !"", metadata !1421, i32 403, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1424 = metadata !{i32 786484, i32 0, null, metadata !"optarg", metadata !"optarg", metadata !"", metadata !1425, i32 57, metadata !213, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1426 = metadata !{i32 786484, i32 0, null, metadata !"optind", metadata !"optind", metadata !"", metadata !1425, i32 71, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1427 = metadata !{i32 786484, i32 0, null, metadata !"opterr", metadata !"opterr", metadata !"", metadata !1425, i32 76, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1428 = metadata !{i32 786484, i32 0, null, metadata !"optopt", metadata !"optopt", metadata !"", metadata !1425, i32 80, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1429 = metadata !{i32 786484, i32 0, metadata !1430, metadata !"nothrow", metadata !"nothrow", metadata !"_ZSt7nothrow", metadata !1431, i32 70, metadata !1432, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1434 = metadata !{i32 786484, i32 0, metadata !115, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale7_S_onceE", metadata !117, i32 307, metadata !1435, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1437 = metadata !{i32 786484, i32 0, metadata !128, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale5facet7_S_onceE", metadata !117, i32 353, metadata !1435, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1438 = metadata !{i32 786484, i32 0, metadata !251, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt6locale2id11_S_refcountE", metadata !117, i32 456, metadata !84, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1439 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7collate2idE", metadata !117, i32 634, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1440 = metadata !{i32 786484, i32 0, metadata !1386, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt8ios_base4Init11_S_refcountE", metadata !5, i32 542, metadata !84, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1441 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt5ctype2idE", metadata !1442, i32 613, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1545 = metadata !{i32 786484, i32 0, metadata !1460, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIcE2idE", metadata !1442, i32 696, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1546 = metadata !{i32 786484, i32 0, metadata !1547, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIwE2idE", metadata !1442, i32 1198, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1679 = metadata !{i32 786484, i32 0, metadata !1680, metadata !"_S_atoms_out", metadata !"_S_atoms_out", metadata !"_ZNSt10__num_base12_S_atoms_outE", metadata !1442, i32 1543, metadata !172, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!1686 = metadata !{i32 786484, i32 0, metadata !1680, metadata !"_S_atoms_in", metadata !"_S_atoms_in", metadata !"_ZNSt10__num_base11_S_atoms_inE", metadata !1442, i32 1547, metadata !172, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1687 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt8numpunct2idE", metadata !1442, i32 1657, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1688 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_get2idE", metadata !1442, i32 1926, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1689 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_put2idE", metadata !1442, i32 2264, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!1690 = metadata !{i32 786484, i32 0, metadata !1384, metadata !"cin", metadata !"cin", metadata !"_ZSt3cin", metadata !1385, i32 60, metadata !1691, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2371 = metadata !{i32 786484, i32 0, metadata !1384, metadata !"cout", metadata !"cout", metadata !"_ZSt4cout", metadata !1385, i32 61, metadata !2372, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2373 = metadata !{i32 786484, i32 0, metadata !1384, metadata !"cerr", metadata !"cerr", metadata !"_ZSt4cerr", metadata !1385, i32 62, metadata !2372, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2374 = metadata !{i32 786484, i32 0, metadata !1384, metadata !"clog", metadata !"clog", metadata !"_ZSt4clog", metadata !1385, i32 63, metadata !2372, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2375 = metadata !{i32 786484, i32 0, metadata !1384, metadata !"wcin", metadata !"wcin", metadata !"_ZSt4wcin", metadata !1385, i32 66, metadata !2376, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3048 = metadata !{i32 786484, i32 0, metadata !1384, metadata !"wcout", metadata !"wcout", metadata !"_ZSt5wcout", metadata !1385, i32 67, metadata !3049, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3050 = metadata !{i32 786484, i32 0, metadata !1384, metadata !"wcerr", metadata !"wcerr", metadata !"_ZSt5wcerr", metadata !1385, i32 68, metadata !3049, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3051 = metadata !{i32 786484, i32 0, metadata !1384, metadata !"wclog", metadata !"wclog", metadata !"_ZSt5wclog", metadata !1385, i32 69, metadata !3049, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3052 = metadata !{void (%"class.hls::stream.28"*, %"class.hls::stream.28"*, i32)* @Simulate_HW, metadata !3053, metadata !3054, metadata !3055, metadata !3056, metadata !3057, metadata !3058}
...
!3059 = metadata !{null, metadata !3060, metadata !3061, metadata !3062, metadata !3063, metadata !3064, metadata !3058}
...
!3065 = metadata !{null, metadata !3060, metadata !3061, metadata !3066, metadata !3063, metadata !3067, metadata !3058}
!3066 = metadata !{metadata !"kernel_arg_type", metadata !"int"}
!3067 = metadata !{metadata !"kernel_arg_name", metadata !"val"}
!3068 = metadata !{null, metadata !3069, metadata !3070, metadata !3071, metadata !3072, metadata !3073, metadata !3058}
!3069 = metadata !{metadata !"kernel_arg_addr_space"}
!3070 = metadata !{metadata !"kernel_arg_access_qual"}
!3071 = metadata !{metadata !"kernel_arg_type"}
!3072 = metadata !{metadata !"kernel_arg_type_qual"}
!3073 = metadata !{metadata !"kernel_arg_name"}
!3074 = metadata !{null, metadata !3060, metadata !3061, metadata !3075, metadata !3063, metadata !3076, metadata !3058}
!3075 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<1> &"}
!3076 = metadata !{metadata !"kernel_arg_name", metadata !"op2"}
!3077 = metadata !{null, metadata !3060, metadata !3061, metadata !3062, metadata !3063, metadata !3078, metadata !3058}
!3078 = metadata !{metadata !"kernel_arg_name", metadata !""}
!3079 = metadata !{i32 786689, metadata !901, metadata !"input", metadata !902, i32 16777224, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3080 = metadata !{i32 8, i32 39, metadata !901, null}
!3081 = metadata !{i32 786689, metadata !901, metadata !"output", metadata !902, i32 33554440, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3082 = metadata !{i32 8, i32 67, metadata !901, null}
!3083 = metadata !{i32 786689, metadata !901, metadata !"size", metadata !902, i32 50331657, metadata !56, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3084 = metadata !{i32 9, i32 7, metadata !901, null}
!3085 = metadata !{i32 19, i32 1, metadata !3086, null}
!3086 = metadata !{i32 786443, metadata !901, i32 9, i32 13, metadata !902, i32 0} ; [ DW_TAG_lexical_block ]
!3087 = metadata !{i32 20, i32 1, metadata !3086, null}
!3088 = metadata !{i32 21, i32 1, metadata !3086, null}
!3089 = metadata !{i32 22, i32 1, metadata !3086, null}
!3090 = metadata !{i32 23, i32 1, metadata !3086, null}
!3091 = metadata !{i32 24, i32 1, metadata !3086, null}
!3092 = metadata !{i32 25, i32 1, metadata !3086, null}
!3093 = metadata !{i32 26, i32 1, metadata !3086, null}
!3094 = metadata !{i32 27, i32 1, metadata !3086, null}
!3095 = metadata !{i32 131, i32 9, metadata !3096, metadata !3097}
!3096 = metadata !{i32 786443, metadata !1327, i32 129, i32 63, metadata !908, i32 21} ; [ DW_TAG_lexical_block ]
!3097 = metadata !{i32 44, i32 15, metadata !3098, null}
!3098 = metadata !{i32 786443, metadata !3099, i32 42, i32 63, metadata !902, i32 3} ; [ DW_TAG_lexical_block ]
!3099 = metadata !{i32 786443, metadata !3100, i32 42, i32 16, metadata !902, i32 2} ; [ DW_TAG_lexical_block ]
!3100 = metadata !{i32 786443, metadata !3086, i32 32, i32 39, metadata !902, i32 1} ; [ DW_TAG_lexical_block ]
!3101 = metadata !{i32 32, i32 12, metadata !3086, null}
!3102 = metadata !{i32 32, i32 40, metadata !3100, null}
!3103 = metadata !{i32 33, i32 1, metadata !3100, null}
!3104 = metadata !{i32 36, i32 1, metadata !3100, null}
!3105 = metadata !{i32 42, i32 21, metadata !3099, null}
!3106 = metadata !{i32 53, i32 26, metadata !3107, null}
!3107 = metadata !{i32 786443, metadata !3100, i32 53, i32 21, metadata !902, i32 6} ; [ DW_TAG_lexical_block ]
!3108 = metadata !{i32 42, i32 64, metadata !3098, null}
!3109 = metadata !{i32 786689, metadata !1327, metadata !"this", metadata !908, i32 16777345, metadata !3110, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3110 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !906} ; [ DW_TAG_pointer_type ]
!3111 = metadata !{i32 129, i32 56, metadata !1327, metadata !3097}
!3112 = metadata !{i32 786688, metadata !3096, metadata !"tmp", metadata !908, i32 130, metadata !1271, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3113 = metadata !{i32 130, i32 22, metadata !3096, metadata !3097}
!3114 = metadata !{i32 786689, metadata !1329, metadata !"this", metadata !912, i32 16777231, metadata !3115, i32 64, metadata !3116} ; [ DW_TAG_arg_variable ]
!3115 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !911} ; [ DW_TAG_pointer_type ]
!3116 = metadata !{i32 130, i32 25, metadata !3096, metadata !3097}
!3117 = metadata !{i32 15, i32 8, metadata !1329, metadata !3116}
!3118 = metadata !{i32 786689, metadata !1330, metadata !"this", metadata !912, i32 16777231, metadata !3115, i32 64, metadata !3117} ; [ DW_TAG_arg_variable ]
!3119 = metadata !{i32 15, i32 8, metadata !1330, metadata !3117}
!3120 = metadata !{i32 15, i32 8, metadata !3121, metadata !3097}
!3121 = metadata !{i32 786443, metadata !1328, i32 15, i32 8, metadata !912, i32 22} ; [ DW_TAG_lexical_block ]
!3122 = metadata !{i32 277, i32 10, metadata !3123, metadata !3120}
!3123 = metadata !{i32 786443, metadata !1326, i32 276, i32 92, metadata !918, i32 20} ; [ DW_TAG_lexical_block ]
!3124 = metadata !{i32 45, i32 4, metadata !3098, null}
!3125 = metadata !{i32 46, i32 4, metadata !3098, null}
!3126 = metadata !{i32 47, i32 5, metadata !3127, null}
!3127 = metadata !{i32 786443, metadata !3098, i32 46, i32 66, metadata !902, i32 4} ; [ DW_TAG_lexical_block ]
!3128 = metadata !{i32 48, i32 4, metadata !3127, null}
!3129 = metadata !{i32 48, i32 11, metadata !3098, null}
!3130 = metadata !{i32 49, i32 5, metadata !3131, null}
!3131 = metadata !{i32 786443, metadata !3098, i32 48, i32 40, metadata !902, i32 5} ; [ DW_TAG_lexical_block ]
!3132 = metadata !{i32 50, i32 4, metadata !3131, null}
!3133 = metadata !{i32 51, i32 3, metadata !3098, null}
!3134 = metadata !{i32 42, i32 58, metadata !3099, null}
!3135 = metadata !{i32 786688, metadata !3086, metadata !"i", metadata !902, i32 29, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3136 = metadata !{i32 53, i32 69, metadata !3137, null}
!3137 = metadata !{i32 786443, metadata !3107, i32 53, i32 68, metadata !902, i32 7} ; [ DW_TAG_lexical_block ]
!3138 = metadata !{i32 57, i32 5, metadata !3139, null}
!3139 = metadata !{i32 786443, metadata !3140, i32 56, i32 69, metadata !902, i32 9} ; [ DW_TAG_lexical_block ]
!3140 = metadata !{i32 786443, metadata !3137, i32 56, i32 22, metadata !902, i32 8} ; [ DW_TAG_lexical_block ]
!3141 = metadata !{i32 56, i32 27, metadata !3140, null}
!3142 = metadata !{i32 56, i32 70, metadata !3139, null}
!3143 = metadata !{i32 786688, metadata !3100, metadata !"Vi", metadata !902, i32 38, metadata !915, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3144 = metadata !{i32 58, i32 5, metadata !3139, null}
!3145 = metadata !{i32 786688, metadata !3100, metadata !"Vj", metadata !902, i32 38, metadata !915, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3146 = metadata !{i32 59, i32 5, metadata !3139, null}
!3147 = metadata !{i32 786688, metadata !3100, metadata !"V", metadata !902, i32 39, metadata !915, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3148 = metadata !{i32 60, i32 13, metadata !3139, null}
!3149 = metadata !{i32 786688, metadata !3100, metadata !"F", metadata !902, i32 39, metadata !915, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3150 = metadata !{i32 129, i32 56, metadata !1327, metadata !3151}
!3151 = metadata !{i32 61, i32 20, metadata !3139, null}
!3152 = metadata !{i32 130, i32 22, metadata !3096, metadata !3151}
!3153 = metadata !{i32 786689, metadata !1329, metadata !"this", metadata !912, i32 16777231, metadata !3115, i32 64, metadata !3154} ; [ DW_TAG_arg_variable ]
!3154 = metadata !{i32 130, i32 25, metadata !3096, metadata !3151}
!3155 = metadata !{i32 15, i32 8, metadata !1329, metadata !3154}
!3156 = metadata !{i32 786689, metadata !1330, metadata !"this", metadata !912, i32 16777231, metadata !3115, i32 64, metadata !3155} ; [ DW_TAG_arg_variable ]
!3157 = metadata !{i32 15, i32 8, metadata !1330, metadata !3155}
!3158 = metadata !{i32 131, i32 9, metadata !3096, metadata !3151}
!3159 = metadata !{i32 15, i32 8, metadata !3121, metadata !3151}
!3160 = metadata !{i32 277, i32 10, metadata !3123, metadata !3159}
!3161 = metadata !{i32 62, i32 5, metadata !3139, null}
!3162 = metadata !{i32 786688, metadata !3100, metadata !"f_acc", metadata !902, i32 40, metadata !915, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3163 = metadata !{i32 63, i32 5, metadata !3139, null}
!3164 = metadata !{i32 786688, metadata !3100, metadata !"v_acc", metadata !902, i32 40, metadata !915, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3165 = metadata !{i32 64, i32 4, metadata !3139, null}
!3166 = metadata !{i32 56, i32 64, metadata !3140, null}
!3167 = metadata !{i32 786688, metadata !3086, metadata !"j", metadata !902, i32 29, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3168 = metadata !{i32 66, i32 4, metadata !3137, null}
!3169 = metadata !{i32 67, i32 5, metadata !3170, null}
!3170 = metadata !{i32 786443, metadata !3137, i32 66, i32 26, metadata !902, i32 10} ; [ DW_TAG_lexical_block ]
!3171 = metadata !{i32 68, i32 5, metadata !3170, null}
!3172 = metadata !{i32 69, i32 4, metadata !3170, null}
!3173 = metadata !{i32 70, i32 4, metadata !3137, null}
!3174 = metadata !{i32 71, i32 4, metadata !3137, null}
!3175 = metadata !{i32 72, i32 3, metadata !3137, null}
!3176 = metadata !{i32 53, i32 63, metadata !3107, null}
!3177 = metadata !{i32 74, i32 3, metadata !3100, null}
!3178 = metadata !{i32 75, i32 2, metadata !3100, null}
!3179 = metadata !{i32 145, i32 31, metadata !3180, metadata !3181}
!3180 = metadata !{i32 786443, metadata !1321, i32 144, i32 79, metadata !908, i32 16} ; [ DW_TAG_lexical_block ]
!3181 = metadata !{i32 90, i32 3, metadata !3182, null}
!3182 = metadata !{i32 786443, metadata !3183, i32 79, i32 57, metadata !902, i32 12} ; [ DW_TAG_lexical_block ]
!3183 = metadata !{i32 786443, metadata !3086, i32 79, i32 10, metadata !902, i32 11} ; [ DW_TAG_lexical_block ]
!3184 = metadata !{i32 146, i32 9, metadata !3180, metadata !3181}
!3185 = metadata !{i32 79, i32 15, metadata !3183, null}
!3186 = metadata !{i32 79, i32 58, metadata !3182, null}
!3187 = metadata !{i32 80, i32 1, metadata !3182, null}
!3188 = metadata !{i32 81, i32 2, metadata !3182, null}
!3189 = metadata !{i32 82, i32 3, metadata !3182, null}
!3190 = metadata !{i32 83, i32 3, metadata !3182, null}
!3191 = metadata !{i32 84, i32 3, metadata !3182, null}
!3192 = metadata !{i32 89, i32 3, metadata !3182, null}
!3193 = metadata !{i32 786689, metadata !1321, metadata !"this", metadata !908, i32 16777360, metadata !3110, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!3194 = metadata !{i32 144, i32 48, metadata !1321, metadata !3181}
!3195 = metadata !{i32 786688, metadata !3180, metadata !"tmp", metadata !908, i32 145, metadata !911, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3196 = metadata !{i32 145, i32 22, metadata !3180, metadata !3181}
!3197 = metadata !{i32 91, i32 2, metadata !3182, null}
!3198 = metadata !{i32 79, i32 52, metadata !3183, null}
!3199 = metadata !{i32 93, i32 2, metadata !3086, null}
!3200 = metadata !{i32 94, i32 3, metadata !3201, null}
!3201 = metadata !{i32 786443, metadata !3086, i32 93, i32 22, metadata !902, i32 15} ; [ DW_TAG_lexical_block ]
!3202 = metadata !{i32 95, i32 3, metadata !3201, null}
!3203 = metadata !{i32 96, i32 2, metadata !3201, null}
!3204 = metadata !{i32 98, i32 1, metadata !3086, null}
