...
#ifndef __Simulate_HW_faddfdEe__HH__
#define __Simulate_HW_faddfdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Simulate_HW_faddfdEe) {
    ...
    SC_CTOR(Simulate_HW_faddfdEe):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
