...
#ifndef __Simulate_HW_fpextg8j__HH__
#define __Simulate_HW_fpextg8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Simulate_HW_fpextg8j) {
    ...
    SC_CTOR(Simulate_HW_fpextg8j):  ACMP_fpext_U ("ACMP_fpext_U") {
